...
public class PessoasController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<PessoasDTO> update(@PathVariable Long id, @RequestBody PessoasDTO pessoaDTO) {
	    PessoasDTO updPessoasDTO = pessoasService.update(id, pessoaDTO);
